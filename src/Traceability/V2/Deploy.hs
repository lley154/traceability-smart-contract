...
module Traceabilty.Deploy
    ( main
    ) where

import           Traceabilty.OnChain                (policy)
import           Traceabilty.Types                  (MintPolicyRedeemer(..), MintPolicyParams(..))
import           Traceabilty.Utils                  (decodeHex, integerToBS)
...
-------------------------------------------------------------------------------------
-- START - traceability Token Metadata - A value entry has a max 64 UTF-8 Byte Limit
-------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------
